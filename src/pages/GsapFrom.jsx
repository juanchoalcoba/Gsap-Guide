    ...
    return (
        <main>
            ...
            <p className="mt-5 text-gray-500">
                ...
                <code>gsap.from()</code> method animate elements from a new state to their current state, white the <code>gsap.to()</code> method animates
                elements from their current state to a new state
            </p>
            <p className="mt-5 text-gray-500">
                Read more about the {" "}
                <a 
                href="https://greenshock.com/docs/v3/GSAP/gsap.from()"
                target="_blank"
